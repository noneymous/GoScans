...
require (
	...
	github.com/mattn/go-adodb v0.0.2-0.20220421143552-48db6f303950
...
// Direct overrides for transitive dependencies pulled in by Nuclei that have
// CVE fixes published ahead of upstream Nuclei catching up. Tracked in THEA-230
// (GO-2026-4910 / GO-2026-4909 / GO-2026-4526). Re-evaluate on next Nuclei bump.
replace (
	github.com/antchfx/xpath => github.com/antchfx/xpath v1.3.6
	github.com/go-git/go-git/v5 => github.com/go-git/go-git/v5 v5.17.1
)
